        ...
        <div className="lg:col-span-6 space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-zinc-400 max-w-md leading-relaxed pt-2">
              Transform random execution into institutional consistency. Track
              metrics, psychology, and risk rules in one unified workspace.
            </p>
          </div>

          {/* Real App Feature Pills */}
            ...
            <div className="w-full bg-[#0e101a] border border-[#1b1e30] rounded-3xl p-8 shadow-2xl space-y-6">
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-1">
                  Enter your details to create your trading journal
                </p>
              </div>
