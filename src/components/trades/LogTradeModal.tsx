...
export function LogTradeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 animate-in fade-in duration-150">
      <div className="bg-[#0e101a] border border-[#1e2133] rounded-2xl w-full max-w-xl overflow-hidden shadow-2xl">
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#1b1d2b]">
          <div className="flex gap-2 p-1 bg-[#141624] rounded-lg border border-[#232536]">
            <button
        ...
        {tab === "manual" && (
          ...
          >
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-2 rounded-lg bg-[#141624] border border-[#232536] text-sm text-white focus:outline-none focus:border-purple-500 uppercase font-mono"
                  placeholder="XAUUSD"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full mt-1 px-3 py-2 rounded-lg bg-[#141624] border border-[#232536] text-sm text-white focus:outline-none focus:border-purple-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-2 rounded-lg bg-[#141624] border border-[#232536] text-sm text-white focus:outline-none focus:border-purple-500 font-mono"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-2 rounded-lg bg-[#141624] border border-[#232536] text-sm text-emerald-400 font-bold focus:outline-none focus:border-purple-500 font-mono"
                  placeholder="+145.00"
                />
              </div>
            </div>
            ...
            <div className="p-3.5 bg-[#121320] border border-[#1f2235] rounded-xl space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full mt-1 p-2 rounded-md bg-[#181a29] border border-[#26283d] text-xs text-white"
                  >
                ...
                <div className="flex flex-col justify-end">
                  <label className="flex items-center gap-2 p-2 rounded-md bg-[#181a29] border border-[#26283d] text-xs text-zinc-300 cursor-pointer">
                    <input
                      type="checkbox"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 px-3 py-1.5 rounded-md bg-[#181a29] border border-[#26283d] text-xs text-white focus:outline-none focus:border-purple-500"
                />
              </div>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-lg bg-purple-600 hover:bg-purple-500 text-white font-semibold text-sm transition-all disabled:opacity-50"
            >
        ...
        {tab === "upload" && (
          <div className="p-8 space-y-4 text-center">
            <div className="border-2 border-dashed border-[#2b2d42] hover:border-purple-500 rounded-2xl p-8 flex flex-col items-center justify-center transition-all bg-[#121320]/50">
              <Upload className="h-10 w-10 text-purple-400 mb-3" />
              <p className="text-sm font-semibold text-white">
                Drop your MT5 Statement here
              </p>
              <p className="text-xs text-zinc-400 mt-1 max-w-xs">
                Export your Trade History from MT5 as an HTML or CSV report and
                drop it in. Duplicate tickets will automatically be skipped.
              </p>
              <label className="mt-4 px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white text-xs font-semibold rounded-lg cursor-pointer transition-all">
